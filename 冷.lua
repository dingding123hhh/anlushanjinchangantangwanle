...
if theme == 'dark' then
    ...
    beijingColor = Color3.fromRGB(25, 25, 25)
      ...
      DropShadow.Image = "rbxassetid://75149002165923" --背景
...
Open.Active = true
Open.Draggable = true
Open.Image = "rbxassetid://133236134493588"
Open.MouseButton1Click:Connect(function()
  Main.Visible = not Main.Visible
  Open.Image = Main.Visible and "rbxassetid://110690407060080" or "rbxassetid://74331171827752" --开关的图
end)
...
UIG.Parent = Open
      ...
      function window.Tab(window, name, icon)
        ...
        TabIco.Image = "rbxassetid://133236134493588" or icon and "rbxassetid://"..icon
...
------------------------------------------------------AL.King音乐-------------------------------------------------------
    ...
    sound.SoundId = "rbxassetid://181313931" --音乐id
...
---------------分割线-------------------------------分割线-------------------------------分割线----------------
        ...
        function tab.section(tab, name, TabVal)
          ...
          SectionOpen.Image = "rbxassetid://133236134493588"
          ...
          SectionOpened.Image = "rbxassetid://110690407060080"
